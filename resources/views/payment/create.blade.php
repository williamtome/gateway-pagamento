...
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Débito</a>--}}
{{--                    </li>--}}
            </ul>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="numero" min="0" class="form-control numero @error('numero') is-invalid @enderror" required>
                                    @error('numero')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
